...
trait TraitTagDetICMS
{
    ...
    public function tagICMS(stdClass $std): DOMElement
    {
        ...
        case '90':
            ...
            break;
        default:
            throw new InvalidArgumentException("O valor [{$std->CST}] não é reconhecido para CST ICMS. Valores aceitos: 00, 10, 20, 30, 40, 41, 50, 51, 60, 70, 90");
        }
    ...
    public function tagICMSSN(stdClass $std): DOMElement
    {
        ...
        default:
            throw new InvalidArgumentException(
                "CSOSN inválido: $std->CSOSN. Valores aceitos: 101, 102, 103, 201, 202, 203, 300, 400, 500, 900"
            );
        }
