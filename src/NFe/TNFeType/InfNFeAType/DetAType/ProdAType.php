...
class ProdAType
{
     ...
     * (NT 2011/004)
     *
     * @property \NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\DIAType[] $dI
     */
    private $dI = null;
     ...
     *
     * @property
     * \NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\DetExportAType[]
     * $detExport
     */
     ...
     * Veículos novos
     *
     * @property \NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\VeicProdAType
     * $veicProd
     */
     ...
     *
     * @property \NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\MedAType[]
     * $med
     */
    private $med = null;
     ...
     * Armamentos
     *
     * @property \NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\ArmaAType[]
     * $arma
     */
    private $arma = null;
     ...
     *
     * @property \NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\CombAType
     * $comb
     */
    private $comb = null;
     ...
     *
     * @return self
     * @param \NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\DIAType $dI
     */
    public function addToDI(\NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\DIAType $dI)
    {
        $this->dI[] = $dI;
        return $this;
    }
     ...
     * (NT 2011/004)
     *
     * @return \NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\DIAType[]
     */
     ...
     *
     * @return self
     * @param \NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\DetExportAType
     * $detExport
     */
    public function addToDetExport(\NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\DetExportAType $detExport)
    {
     ...
     * Detalhe da exportação
     *
     * @return \NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\DetExportAType[]
     */
     ...
     * Veículos novos
     *
     * @return \NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\VeicProdAType
     */
     ...
     * Veículos novos
     *
     * @param \NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\VeicProdAType
     * $veicProd
     * @return self
     */
    public function setVeicProd(\NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\VeicProdAType $veicProd)
    {
     ...
     *
     * @return self
     * @param \NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\MedAType $med
     */
    public function addToMed(\NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\MedAType $med)
    {
        $this->med[] = $med;
        return $this;
    }
     ...
     * grupo do detalhamento de Medicamentos e de matérias-primas farmacêuticas
     *
     * @return \NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\MedAType[]
     */
     ...
     *
     * @return self
     * @param \NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\ArmaAType $arma
     */
    public function addToArma(\NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\ArmaAType $arma)
    {
        $this->arma[] = $arma;
        return $this;
    }
     ...
     * Armamentos
     *
     * @return \NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\ArmaAType[]
     */
     ...
     * Informar apenas para operações com combustíveis líquidos
     *
     * @return \NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\CombAType
     */
     ...
     * Informar apenas para operações com combustíveis líquidos
     *
     * @param \NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\CombAType $comb
     * @return self
     */
    public function setComb(\NFePHP\NFe\NFe\TNFeType\InfNFeAType\DetAType\ProdAType\CombAType $comb)
    {
        $this->comb = $comb;
        return $this;
    }
