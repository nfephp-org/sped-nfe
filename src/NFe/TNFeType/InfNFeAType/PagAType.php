...
class PagAType
{
     ...
     * Grupo de Cartões
     *
     * @property \NFePHP\NFe\NFe\TNFeType\InfNFeAType\PagAType\CardAType $card
     */
    private $card = null;
     ...
     * Grupo de Cartões
     *
     * @return \NFePHP\NFe\NFe\TNFeType\InfNFeAType\PagAType\CardAType
     */
     ...
     * Grupo de Cartões
     *
     * @param \NFePHP\NFe\NFe\TNFeType\InfNFeAType\PagAType\CardAType $card
     * @return self
     */
    public function setCard(\NFePHP\NFe\NFe\TNFeType\InfNFeAType\PagAType\CardAType $card)
    {
        $this->card = $card;
        return $this;
    }
